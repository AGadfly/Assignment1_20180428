	...
	public static void main(String[] args) {
		try {
			...
			for (int i = 0; i < baseVoltList.getLength(); i++) {
				...
				String baseVolt_nominalVoltage = baseVolt.nominalVoltage(baseVoltList.item(i));
			...
			for (int i = 0; i < generatingUnit.getLength(); i++) {
				...
				String GeneUnit_maxP = genunit.maxP(generatingUnit.item(i));
				String GeneUnit_minP = genunit.minP(generatingUnit.item(i));
